...
<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
				...
				<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    ...
                    elseif ( $start >= $num_rows )
                      ...
                      echo '
                      <p>
                      <a href="/animals?cate='.$cat.'&num='.$initial.'" title="Previous">Previous</a>
                      </p>';
                    }
                    elseif ( $start == 9 && 9 < $num_rows )
                    {
                      echo '
                      <p>
                      <a href="/animals?cate='.$cat.'&num='.$start.'" title="Next">Next</a>
                      </p>';
                    } 
                    else
                    { 
                      ...
                      <p>
                      <a href="/animals?cate='.$cat.'&num='.$initial.'" title="Previous">Previous</a>  
                      <a href="/animals?cate='.$cat.'&num='.$start.'" id="nextButton" title="Next">Next</a>
                      </p>';
                    }        
                    echo '</div>';
                  }
