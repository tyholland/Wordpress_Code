...
$xml_url = 'http://api.ebaycommercenetwork.com/publisher/3.0/rest/GeneralSearch?apiKey=33d668ef-38e2-4b1e-a983-cb006cf7e3e3&trackingId=8096979&visitorUserAgent='.$userAgent.'&visitorIPAddress='.$ipAddress.'&keyword=hoodie&numItems=20&attributeValue=71827_sweaters_and_sweatshirts&categoryId=31515&showOnSaleOnly=true&showOffersOnly=true&pageNumber='.$pg.$range;
...
?>
			<div id="theMall" class="entry-content">
				...
				<?php } else { ?>
					...
					<div class="fleft" style="padding: 0 0 2% 0;">
						<img src="/wp-content/uploads/2015/09/hoodman.png" class="fleft" style="width: 10%; padding: 0 2% 0 0;" />
						<div class="fleft" style="width: 85%;">
							There are two things that go into making cool sweatshirts.  Your personal taste is a huge factor, because what is cool to me, might not be cool to you.  And 2nd; the price.  The sweatshirt can be as cool as it wants to be, but if you can't afford it; so what!  We have a wide variety of cool sweatshirts.  So you'll find the styles you like, at prices that you'll like even better.  Shop our mall of cool sweatshirts and hoodies now.  I promise that you'll leave satisfied.
						</div>
					</div>
