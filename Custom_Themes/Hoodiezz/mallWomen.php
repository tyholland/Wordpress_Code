...
$products = $wpdb->get_results($wpdb->prepare('SELECT * FROM productUpload WHERE prod_category = "wClothes" OR prod_category = "wHeadgear" OR prod_category = "wShoes" ORDER BY ID DESC LIMIT %d, 20', $currentPg));
...
* The Pagination
**************************************************************************/
$theCount = $wpdb->get_var('SELECT COUNT(*) FROM productUpload WHERE  prod_category = "wClothes" OR prod_category = "wHeadgear" OR prod_category = "wShoes"');
					...
					<div id="productDiv">
						...
						<div>
							<select id="womenClothing">
								<option value="wOutfit" selected>All Outfits</option>
								<option value="wClothes">Clothes</option>
								<option value="wHeadgear">Headgear</option>
