...
$products = $wpdb->get_results($wpdb->prepare('SELECT * FROM productUpload WHERE prod_category = "mClothes" OR prod_category = "mHeadgear" OR prod_category = "mShoes" ORDER BY ID DESC LIMIT %d, 20', $currentPg));
...
* The Pagination
**************************************************************************/
$theCount = $wpdb->get_var('SELECT COUNT(*) FROM productUpload WHERE  prod_category = "mClothes" OR prod_category = "mHeadgear" OR prod_category = "mShoes"');
					...
					<div id="productDiv">
						...
						<div>
							<select id="menClothing">
								<option value="mOutfit" selected>All Outfits</option>
								<option value="mClothes">Clothes</option>
								<option value="mHeadgear">Headgear</option>
								<option value="mShoes">Shoes</option>
							</select>
