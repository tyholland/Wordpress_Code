...
$products = $wpdb->get_results($wpdb->prepare('SELECT * FROM productUpload WHERE prod_category = "mClothes" ORDER BY ID DESC LIMIT %d, 20', $currentPg));
...
* The Pagination
**************************************************************************/
$theCount = $wpdb->get_var('SELECT COUNT(*) FROM productUpload WHERE  prod_category = "mClothes"');
					...
					<div id="productDiv">
						...
						<div>
							<select id="menClothing">
								...
								<option value="mClothes" selected>Clothes</option>
