...
$products = $wpdb->get_results($wpdb->prepare('SELECT * FROM productUpload WHERE prod_category = "wClothes" ORDER BY ID DESC LIMIT %d, 20', $currentPg));
...
* The Pagination
**************************************************************************/
$theCount = $wpdb->get_var('SELECT COUNT(*) FROM productUpload WHERE  prod_category = "wClothes"');
					...
					<div id="productDiv">
						...
						<div>
							<select id="womenClothing">
								...
								<option value="wClothes" selected>Clothes</option>
